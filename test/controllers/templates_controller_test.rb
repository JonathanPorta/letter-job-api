...
class TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create template" do
    assert_difference('Template.count') do
      post templates_url, params: { template: { content: @template.content, user_id: @template.user_id } }
    end
  ...
  test "should update template" do
    patch template_url(@template), params: { template: { content: @template.content, user_id: @template.user_id } }
